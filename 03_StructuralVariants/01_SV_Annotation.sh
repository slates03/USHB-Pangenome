...
bcftools view ${OUT}/ANNO_MU_pan_120dronesamples.flt.vcf.gz -f 'QUAL>30' -Ov  | \
...
singularity exec vep.sif vep -i CPX_SV_pan_head_120dronesamples.flt.vcf.gz -o CPX_SV_pan_head_120dronesamples.flt.txt \
