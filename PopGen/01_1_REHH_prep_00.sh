...
export VCF_DIR="/90daydata/virus_rnaseq/2022_WGS_drone_stock/drone_samples/data/05A_PopGen/VCF/Biallelic"
...
mkdir ${Final_DIR}/${U_line}

# split by chromosome
for lg in ${chr_set}
do
vcftools --recode --gzvcf ${VCF_DIR}/${U_line}_ALL_BI_pan_120dronesamples.flt2.vcf.gz --chr ${lg} --out ${Final_DIR}/${U_line}/${U_line}_${lg}
done
